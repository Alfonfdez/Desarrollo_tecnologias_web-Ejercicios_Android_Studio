...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView iv_image;//IMAGEN ESCOGIDA DE 'PICASSO'
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_image = findViewById(R.id.iv_image);//IMAGEN ESCOGIDA DE 'PICASSO'


        /*---DECLARACIONES---*/

        //AÑADIR FOTOS DE INTERNET GRACIAS A LA LIBRERÍA 'PICASSO'
